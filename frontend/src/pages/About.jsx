      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            An AI-powered personalized learning platform that adapts to each learner and provides real-time analytics for both learners and educators.
          </p>
        </div>
        ...
        <div className="card mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            ...
            By leveraging Google Gemini AI, the platform classifies learners into adaptive levels, generates targeted
