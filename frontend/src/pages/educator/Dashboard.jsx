      ...
      <ReportExporter title="Analytics & Reports" filename={`Class_Report_${new Date().toISOString().split('T')[0]}.pdf`}>
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            {(data.coursePerformance?.length > 0 || pieData.some((d) => d.value > 0)) && (
              <Suspense
                fallback={
                  <div className="md:col-span-2 grid md:grid-cols-2 gap-4 sm:gap-6">
                    <div className="h-[220px] rounded-xl bg-gray-50 dark:bg-gray-800/50 animate-pulse border border-gray-100 dark:border-gray-700" />
                    <div className="h-[220px] rounded-xl bg-gray-50 dark:bg-gray-800/50 animate-pulse border border-gray-100 dark:border-gray-700" />
                  </div>
                }
              >
                <EducatorPerformanceCharts
